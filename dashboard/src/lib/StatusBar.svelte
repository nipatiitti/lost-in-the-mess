...
<div class="shell-top" style="height: var(--header-h)">
  ...
  <div style="flex-shrink: 0; padding: 0 16px; display: flex; align-items: center; gap: 10px;">
    ...
    <div style="position: relative; z-index: 10; width: 120px; height: 24px; border: 1px solid var(--border); background: rgba(255, 255, 255, 0.05); border-radius: 4px; overflow: hidden;">
